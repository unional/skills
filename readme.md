...
| **[add-starlight-docs-site](skills/add-starlight-docs-site)** | Add an Astro + Starlight docs site to a repo and deploy it to GitHub Pages, matching the cyberuni house layout. Insists every documented example come from a test assertion. |
